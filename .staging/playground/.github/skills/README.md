...
1. **Steps** — ordered, actionable instructions.
1. **References** — links to specifications, agents, or documentation.
1. **Constraints** — what the skill must not do.
...
1. Create `SKILL.md` with the required frontmatter and body.
1. Follow the conventions documented in this file.
1. Reference relevant specifications under `.github/specs/`.
1. Avoid duplicating guidance that already exists in other documents.
