...
1. The user captures it as a reflection record with body, optional title, and optional tags.
1. The record is stored locally and becomes visible in the reflection list.
1. The record can be reopened in a detail view for review.
1. Optional AI-oriented services may derive summaries, themes, coaching prompts, or feedback later.
