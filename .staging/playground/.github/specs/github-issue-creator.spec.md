...
1. `ARCHITECTURE.md`
1. `ONBOARDING.md`
1. relevant specifications under `.github/specs/`
1. relevant agents and skills
1. repository structure
1. current implementation files
1. tests
1. build and task automation
1. existing related issues
...
1. Inspect relevant repository context when available.
1. Determine whether the request is one issue or a roadmap.
1. Select the most appropriate issue type.
1. Preserve the motivating problem.
1. Define current and desired state.
1. Establish scope and constraints.
1. Reference authoritative specifications.
1. Define implementation guidance.
1. Define validation.
1. Produce testable acceptance criteria.
1. Surface unresolved questions.
1. Avoid implementation unless requested.
1. Avoid automatically creating issues unless authorized.
1. Return a copy-ready result.
