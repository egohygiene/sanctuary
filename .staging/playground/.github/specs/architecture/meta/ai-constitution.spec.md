...
1. Defining enduring behavioral expectations.
1. Preserving human authority.
1. Separating governance from implementation.
1. Remaining independent of any specific AI provider.
1. Producing constitutional guidance that remains stable as AI technology
   evolves.
