...
1. Identifying architectural layers.
1. Mapping dependency relationships.
1. Explaining the purpose of each layer.
1. Avoiding duplication of document content.
1. Producing an architectural overview suitable for both humans and AI.
