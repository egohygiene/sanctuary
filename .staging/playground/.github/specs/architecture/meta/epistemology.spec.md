...
1. Defining how knowledge should be evaluated.
1. Explaining confidence and uncertainty.
1. Defining provenance expectations.
1. Preserving transparency.
1. Producing guidance that remains applicable regardless of implementation.
