...
1. Understanding the project's long-term vision.
1. Identifying major capabilities required to achieve that vision.
1. Organizing capabilities into strategic phases.
1. Avoiding implementation planning.
1. Producing a roadmap that can evolve without invalidating existing work.
