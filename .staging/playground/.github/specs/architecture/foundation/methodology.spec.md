...
1. Identifying repeatable engineering practices.
1. Separating methodology from implementation.
1. Defining workflows that humans and AI can both follow.
1. Favoring deterministic and observable engineering processes.
1. Producing guidance that remains useful as technologies evolve.
