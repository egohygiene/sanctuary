...
1. Identifying assumptions that remain true regardless of implementation.
1. Separating enduring truths from temporary decisions.
1. Defining architectural invariants.
1. Producing a stable conceptual foundation for the remainder of the
   architecture.
