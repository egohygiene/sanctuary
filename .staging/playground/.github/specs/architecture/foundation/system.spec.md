...
1. Identifying the project's major capabilities.
1. Grouping related capabilities into cohesive systems.
1. Defining responsibilities for each system.
1. Establishing clear conceptual boundaries.
1. Producing a stable system decomposition independent of implementation.
