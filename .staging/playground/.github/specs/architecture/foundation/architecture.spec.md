...
1. Organizing responsibilities into architectural layers.
1. Defining module boundaries.
1. Documenting dependency relationships.
1. Producing a stable architecture capable of evolving over time.
