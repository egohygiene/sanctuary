...
1. Understanding the long-term impact the project seeks to create.
1. Describing the future state toward which the project evolves.
1. Eliminating implementation details.
1. Preserving consistency with the project's purpose.
1. Producing an aspirational but believable vision.
