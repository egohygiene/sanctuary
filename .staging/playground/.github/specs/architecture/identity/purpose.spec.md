...
1. Identifying who benefits from the project.
1. Describing the enduring value created by the project.
1. Eliminating implementation details.
1. Distinguishing purpose from vision.
1. Producing a concise, timeless statement of intent.
