...
1. Understanding the project's purpose and vision.
1. Identifying the enduring capabilities required for success.
1. Eliminating temporary initiatives.
1. Distinguishing strategic capabilities from implementation.
1. Producing a stable collection of long-term pillars.
