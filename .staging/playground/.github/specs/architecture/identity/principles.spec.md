...
1. Identifying the project's core beliefs.
1. Translating those beliefs into practical decision heuristics.
1. Eliminating implementation-specific guidance.
1. Preserving consistency across architecture documents.
1. Producing principles that remain valuable as technologies evolve.
