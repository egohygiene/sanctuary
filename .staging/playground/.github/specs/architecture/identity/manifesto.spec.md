...
1. Identifying the project's deepest beliefs.
1. Expressing those beliefs clearly and authentically.
1. Avoiding technical implementation.
1. Preserving consistency with the project's philosophy.
1. Producing writing intended for people rather than software.
