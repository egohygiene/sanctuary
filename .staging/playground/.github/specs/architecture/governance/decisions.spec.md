...
1. Identifying major architectural and engineering decisions.
1. Explaining the rationale behind each decision.
1. Recording important alternatives when known.
1. Preserving historical context.
1. Avoiding speculation about undocumented reasoning.
