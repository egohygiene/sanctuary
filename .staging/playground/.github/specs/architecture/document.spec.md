...
1. Avoid duplication.
1. Respect document ownership boundaries.
1. Prefer extending existing concepts.
1. Produce deterministic output where possible.
1. Explain assumptions when required information is unavailable.
