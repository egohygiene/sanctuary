...
1. Understanding the project's personal model.
1. Identifying the experiences the project seeks to create.
1. Expressing enduring design values.
1. Avoiding implementation guidance.
1. Producing a philosophy that remains stable as technology evolves.
