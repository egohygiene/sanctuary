...
1. Understanding the project's design philosophy.
1. Identifying reusable visual and interaction patterns.
1. Separating conceptual design language from implementation.
1. Preserving consistency across every user-facing experience.
1. Producing implementation-independent guidance.
