...
1. Understanding the ontology before modeling people.
1. Identifying the assumptions the project makes about individuals.
1. Describing those assumptions in implementation-independent language.
1. Preserving consistency across the architecture.
1. Avoiding unsupported claims or unnecessary complexity.
