...
1. Separate goals from non-goals.
1. Define clear requirements.
1. Describe architecture before implementation.
1. Break implementation into phases.
1. Include validation steps.
1. Include acceptance criteria.
1. List open questions instead of guessing.
1. Avoid over-engineering.
1. Prefer simple, explicit language.

---

1. GitHub Issue Generation Rules
