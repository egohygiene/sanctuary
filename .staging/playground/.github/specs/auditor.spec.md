...
1. Architecture and system documents (`ARCHITECTURE.md`, `SYSTEM.md`, `DESIGN.md`)
1. Governance and contribution files (`AI_CONSTITUTION.md`, `CONTRIBUTOR_GUIDE.md`, `DECISIONS.md`)
1. Existing specifications under `.github/specs/`
1. Agent and skill files under `.github/agents/` and `.github/skills/`
1. Build and task automation (`Taskfile.yml`, `Makefile`, `package.json`, etc.)
1. Dependency manifests (`pubspec.yaml`, `package.json`, `pyproject.toml`, etc.)
1. CI/CD workflows under `.github/workflows/`
1. Source code under `lib/`, `src/`, `apps/`, etc.
1. Tests
1. Documentation under `docs/`
1. Existing audits under `audits/`
