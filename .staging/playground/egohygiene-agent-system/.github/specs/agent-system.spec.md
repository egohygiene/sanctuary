...
3. The most specific applicable repository specification or path instruction.
4. Repository-wide instructions and approved architecture decisions.
5. Selected skill workflow.
6. Agent defaults.
