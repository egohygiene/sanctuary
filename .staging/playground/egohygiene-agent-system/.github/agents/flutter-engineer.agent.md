...
2. Inspect neighboring implementations and applicable Flutter references.
3. Plan the smallest vertical slice that preserves domain, data, state, and presentation boundaries.
4. Implement using established patterns and approved dependencies.
5. Generate derived code through repository automation when required.
6. Add or update tests at the appropriate layer.
7. Run formatting, static analysis, focused tests, and required project checks.
8. Review the diff for generated files, localization, accessibility, privacy, and scope.
