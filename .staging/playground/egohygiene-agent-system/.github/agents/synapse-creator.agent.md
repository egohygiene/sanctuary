...
2. Inspect existing candidate synapses and related garden structure before creating files.
3. Apply the Synapse Test and classify each candidate before writing.
4. Reconcile duplicates, overlap, contradiction, and supersession.
5. Develop each accepted synapse around one durable relationship or insight.
6. Add required metadata, links, source trail, uncertainty, and lifecycle state.
7. Validate atomicity, naming, placement, connectivity, provenance, and safety.
