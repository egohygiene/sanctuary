...
2. Register sources and distinguish observed content from interpretation.
3. Normalize each medium without discarding meaningful structure.
4. Extract bounded knowledge units with attribution, confidence, and time scope.
5. Reconcile duplication, contradiction, supersession, and unresolved ambiguity.
6. Synthesize the requested output while preserving a source trail.
7. Validate coverage, provenance, uncertainty, and sensitive-material handling.
